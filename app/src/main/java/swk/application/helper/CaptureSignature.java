...
/**
 * Helperklasse zur Erfassung von Unterschriften
 * @author endres
 *
 */
public class CaptureSignature extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.helper_signature);

		/*
		 * Stores SignatureDialogScreen at the Bottom of the Device
		 */
		...
		LinearLayout ll = (LinearLayout) inflater.inflate(
				R.layout.helper_signature, null);
		setContentView(ll, wmlp);
		...
		mContent = (LinearLayout) findViewById(R.id.linearLayoutsignature);
	...
	public class signature extends View {
		...
		public void save(View v) {
			...
			try {
				...
				// TODO
				/*
				 * Convert Bitmap to byteArray-->later TODO Save byteArray as
				 * Blob in Database!!
				 * 
				 * 
				 * Bitmap yourBitmap; ByteArrayOutputStream bos = new
